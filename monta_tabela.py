...
lista_follows = [
    ...
    ["L'", [';', ')']],
    ["EXPRESSION", [';', ')']],
    ["EXPRESSION'", [';', ')', '(', 'int_constant', 'float_constant', 'string_constant', 'ident']],
    ["NUMEXPRESSION", [']', ')']],
    ["NUMEXPRESSION'", [']', ')', ';', '<', '>', '<=', '>=', '==', '!=', 'int_constant', 'float_constant', 'string_constant', 'ident', '(']],
    ["TERM", ['+', '-', ']', ')']],
    ["TERM'", ['int_constant', 'float_constant', 'string_constant', 'ident', '+', '-', ']', ')', ';', '<', '>', '<=', '>=', '==', '!=', '(']],
    ["UNARYEXPR", ['*', '/', '%', '+', '-', ']', ')']],
    ["FACTOR", ['*', '/', '%', '+', '-', ']', ')']],
    ["LVALUE", ['=', '*', '/', '%', '+', '-', ']', ')']],
    ["LVALUE'", ['ident', 'int_constant', 'float_constant', 'string_constant', '=', '*', '/', '%', '+', '-', ']', ')', ';', '<', '>', '<=', '>=', '==', '!=', '(']],
]
