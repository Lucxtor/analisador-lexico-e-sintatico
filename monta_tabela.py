...
lista_follows = [
    ...
    ["IFSTAT2", ['{', 'break', ';', 'int', 'float', 'string', 'print', 'return', 'for', 'ident', 'if', 'read', '}', 'call', '$']],
    ...
    ["ALLOCEXPRESSION3", [';', ')']],
    ["EXPRESSION", [';', ')']],
    ["EXPRESSION'", [';', ')', '(', 'int_constant', 'float_constant', 'string_constant', 'ident', 'return']],
    ["NUMEXPRESSION", [']', ')']],
    ["NUMEXPRESSION'", [']', ')', ';', '<', '>', '<=', '>=', '==', '!=', 'int_constant', 'float_constant', 'string_constant', 'ident', 'return', '(']],
    ["TERM", ['+', '-', ']', ')']],
    ["TERM'", ['return', 'int_constant', 'float_constant', 'string_constant', 'ident', '+', '-', ']', ')', ';', '<', '>', '<=', '>=', '==', '!=', '(']],
    ["UNARYEXPR", ['*', '/', '%', '+', '-', ']', ')']],
    ["FACTOR", ['*', '/', '%', '+', '-', ']', ')']],
    ["LVALUE", ['=', '*', '/', '%', '+', '-', ']', ')']],
    ["LVALUE'", ['ident', 'return', 'int_constant', 'float_constant', 'string_constant', '=', '*', '/', '%', '+', '-', ']', ')', ';', '<', '>', '<=', '>=', '==', '!=', '(']],
]
